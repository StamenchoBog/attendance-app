...
class _CasLoginScreenState extends State<CasLoginScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('University Login'), backgroundColor: ColorPalette.darkBlue),
      body: Stack(
        children: [
              ...
              child: Center(
                child: Column(
                  ...
                  children: [
                    ...
                    Text('Connecting to university login...', style: TextStyle(fontSize: 14.sp)),
                  ],
                ),
              ),
            ),
              ...
              child: Center(
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 16.h),
                    ElevatedButton(
                      style: ElevatedButton.styleFrom(backgroundColor: ColorPalette.darkBlue),
                      onPressed: () {
                        setState(() {
                          _errorMessage = null;
                          _controller.reload();
