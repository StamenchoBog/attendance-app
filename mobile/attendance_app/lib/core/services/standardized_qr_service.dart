...
class StandardizedQRService {
  static final AttendanceRepository _attendanceRepository = locator<AttendanceRepository>();
  ...
  static Future<void> _generateQRCodeAndShowDialog(
    ...
    try {
      ...
      // Create presentation session with beacon configuration
      final response = await _attendanceRepository.createPresentationSession(
        sessionId,
      ...
      if (context.mounted) {
        ...
        await _showStandardizedQRDialog(
          context,
          qrBytes,
          presentationUrl,
          beaconMode,
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            Text(
              'Or tap the link to open in a browser:',
